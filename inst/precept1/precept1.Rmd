...
you decide you never want to save and and don't want to be asked again).
...
the data in the `data` folder. It is called `saf_subset.tsv`, so the path 
from the folder where this file is to the data is `data/saf_subset.tsv`.  
...
Often times, when you use data for your research, variable names 
