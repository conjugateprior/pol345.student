...
for (i.fibonacci in 3:1000) {
  fibonacci[i.fibonacci] <- fibonacci[i.fibonacci - 1] + 
    fibonacci[i.fibonacci - 2] 
}
fibonacci[1:30]
```
...
for (i.fibonacci in 3:1000) {
  fibonacci[i.fibonacci] <- fibonacci[i.fibonacci - 1] + 
    fibonacci[i.fibonacci - 2] 
  ratio.fibonacci[i.fibonacci] <- fibonacci[i.fibonacci] / 
...
```{r}
demsvsindep <- isolate.byyear[1, ] - isolate.byyear[3, ]
repsvsindep <- isolate.byyear[7, ] - isolate.byyear[3, ]
...
approximately 1970, Republicans are more interventionist when a co-partisan 
